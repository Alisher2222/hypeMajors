...
router.post("/analyze", async (req, res) => {
  ...
  try {
    ...
    const bestPost = posts.reduce((top, post) => post.likesCount > (top.likesCount || 0) ? post : top, {});
    const trendDirection = chartData[chartData.length - 1].likes > chartData[0].likes ? "rising" : "falling";
